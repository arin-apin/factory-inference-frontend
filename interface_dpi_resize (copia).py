...
def main():
   ...
   #llamada a las labels
    ...
    button_3 = img_button3.resize((300, 120), ImagePIL.Resampling.LANCZOS)
    ...
    button_2 = img_button2.resize((300 , 120), ImagePIL.Resampling.LANCZOS)
    ...
    framewebcam.grid(row=1, column=0, rowspan=1)
    ...
    #texto titulo interfaz
    frame = Frame(master=window, relief=RAISED,
                      borderwidth=1, )
    frame.grid(row=0, column=0, sticky="nsew")
    label = Label(master=frame,text="Interface for inference \n Camera feed", compound='center', font=("Arial",14),
                    fg='#21ab4b',bg='black')
    ...
    label_inf = Label(master=frame,image=image_image_crop, text="waiting trigger button press", compound='center', font=("Arial",14),
                    fg='#21ab4b',bg='purple')
    ...
    for i in range(3):
        ...
        Button1 = Button(
            master=frame, image=image_list[i], width=400, height=120, bg='white')
    ...
    for i in range(3, len(image_list)):
        frame = Frame(master=window, relief=RAISED,
                      borderwidth=1, )
        frame.grid(row=i-2, column=1, sticky="nsew")
