...
def inferencia(img):
    ...
    resultado_max = resultado_max+"Tiempo inferencia: "+str(time.time()-inicio)
...
def main():
    ...
    model="test_inference/clients_q6FvDq3pIxV4sVjE7qZfCTSn9Wx2_3zOMj9FWxuWXvvLBemGu_PwqO7ZHwZ1Kbt5V2KMBq.tflite"
    labels_path = "test_inference/labels.txt"
   ...
   #llamada a las labels
    ...
    while True:
        ...
        framePIL = ImagePIL.open("./test_inference/clients_q6FvDq3pIxV4sVjE7qZfCTSn9Wx2_3zOMj9FWxuWXvvLBemGu_black clip_ok_11_GM623.1A01-CAM1-2022_04_01-04-31-17.png")
        ...
        if flag_inferencia == 1:
            ...
            res_inferencia, _ = inferencia(framePIL)
